	...
	public static void main(String[] args) {
		...
		try {
			...
			if (flag == 0) {
				...
				System.out.println("########################################");
				System.out.println();
				System.out.println("Received request for" + FileName + " filename from clientipaddress port clientport "
						+ FileName);
				try {
			...
			while (true && result != -1) {
				...
				if (random.nextDouble() < LOSS_RATE) {
					System.out.println("RDT forgot CONSIGNMENT #" + consignment);
					continue;
				}
				...
				System.out.println("RDT CONSIGNMENT #" + consignment);
